...
>```
>Me ajude a documentar um agente de IA financeiro. O caso de uso é [descreva o caso de uso]. Preciso definir: problema que resolve,
>público-alvo, personalidade do agente, tom de voz e estratégias anti-alucinação. Use o template abaixo como base:
>
